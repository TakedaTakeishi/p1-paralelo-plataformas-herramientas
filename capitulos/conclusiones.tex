...
% - Reflexión personal
En esta práctica pude aprender el valor del trabajo en equipo, puesto que, aunque hemos tenido muchas dificultades (bitlocker, secure boot, \LaTeX, GitHub, etc.) en todo momento nos hemos apoyado incluso en la adversidad. Estoy muy contento de poder trabajar con unos compañeros así. Hace que valga la pena el esfuerzo y empeño.

La mayor dificultad ha sido la combinación de factores que nos llevaron a no poder entregarlo en tiempo y forma la primera ocasión. Dado que se juntaron: 
\begin{itemize}
    \item Una instalación de Linux.
    \item La utilización de \LaTeX en local.
    \item La sincronización de los trabajos a través de GitHub.
    \item Investigación completa del marco teórico.
    \item Corrección de errores de todo tipo.
\end{itemize}

En fin, a pesar de todo he aprendido cómo mejorar mi capacidad de investigación aún más. En primer lugar puedo apoyarme con la IA para comprender los temas que debo buscar, en segundo lugar aprendí que hay herramientas especializadas en encontrar papers, como lo es Consensus y finalmente que se puede usar Zotero para descargar los PDF de manera automática. Esto me ha ahorrado muchísimo tiempo y me ha permitido encontrar referencias de calidad para el marco teórico.
% ==========================================
