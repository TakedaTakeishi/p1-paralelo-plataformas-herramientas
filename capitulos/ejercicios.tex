...
2) rm notas*: Borra cualquier archivo que empiece con "notas", como "notas1.txt", "notas_viejas.doc", etc.
...
Explicación: Crea un archivo llamado "lista_archivos.txt" con el contenido de la carpeta. Si el archivo ya existía, se pierde lo que tenía antes.

2.- Operador >> (Añadir): Envía la salida al final del archivo sin borrar lo que ya tiene (modo "append").

Ejemplo: date >> registro.log
